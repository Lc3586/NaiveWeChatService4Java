...
import top.lctr.naive.wechat.service.common.ServiceObjectResolve;
import top.lctr.naive.wechat.service.configure.TestMpConfigure;
...
public class M1S1OAuth2Test {
     ...
     */
    @ParameterizedTest
    @MethodSource("top.lctr.naive.wechat.service.configure.TestMpConfigure#getMultiTestMpName")
